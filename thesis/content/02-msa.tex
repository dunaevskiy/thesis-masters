...
\begin{dl}
   ...
   \item[\g{SOA}] – jednoprocesový program s interním rozdělením na služby, které mezi sebou komunikují s pomocí zpráv přímo s využitím vyčleněného rozhraní nebo přes \g{ESB} – sběrnicí určenou pro centralizaci komunikace mezi službami \TODO{cite}.
