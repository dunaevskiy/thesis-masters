...
\begin{dl}
   ...
   Taková struktura přináší komplikace z hlediska provádění tranzakcí prováděné přes několik datových úložišť a agregace, které vzhledem k fyzickému oddělení nelze provádět jedním \g{SQL} dotazem.
